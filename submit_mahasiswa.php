...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Encrypt data lainnya sebelum disimpan
    ...
    $sql = "INSERT INTO tblmahasiswa (npm, nama, alamat, tempat_lahir, tanggal_lahir, asal_sma) 
            VALUES ('$npm', '$nama_encrypted', '$alamat_encrypted', '$tempat_lahir_encrypted', '$tanggal_lahir_encrypted', '$asal_sma_encrypted')";
